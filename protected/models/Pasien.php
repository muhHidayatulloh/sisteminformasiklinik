...
class Pasien extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('nama_pasien, id_wilayah', 'required'),
			// array('id_tindakan, id_list_obat, id_wilayah', 'numerical', 'integerOnly'=>true),
			array('nama_pasien', 'length', 'max'=>32),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_pasien, nama_pasien, id_tindakan, id_list_obat, id_wilayah', 'safe', 'on'=>'search'),
		);
	}
